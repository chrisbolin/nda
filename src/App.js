  ...
  return (
    <div className="main">
      ...
      <div className="print">
        ...
        <p>The Receiving Party expressly acknowledges and affirms their consent to be bound by the terms and conditions set forth in this Agreement. Henceforth, this Agreement can be referred to as a "Non-Disclosure Agreement" or "NDA." The primary objective of this Agreement is enable the Receiving Party to claim truthly that they have "signed an NDA" concerning the information as described in Section III below. This Agreement shall commence its effect on the Effective Date and shall remain in effect for ten (10) years henceforth.</p>
